...
# STEP 1 — Employees in Boston: first name, last name
...
# STEP 3 — All employees + office city/state, ordered by name
...
# STEP 4 — Customers who have never placed an order
...
# STEP 5 — Payments, sorted by amount descending
...
# STEP 6 — Sales reps whose customers average credit limit over 90k
...
# STEP 8 — Products by number of distinct purchasers
...
# STEP 10 — Employees who sold underperforming products (fewer than 20 distinct customers)
